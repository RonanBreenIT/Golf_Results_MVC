    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        CompResultID = c.Int(nullable: false, identity: true),
                        ...
                        GolferScore = c.String(),
                    })
                .PrimaryKey(t => t.CompResultID)
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Comp_Result", new[] { "GolferID" });
            DropIndex("dbo.Comp_Result", new[] { "CompetitionID" });
