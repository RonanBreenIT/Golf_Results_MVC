...
When you deploy an application to a production web server, you must remove or disable code that drops and re-creates the database. */
    public class GolfInitializer: System.Data.Entity.DropCreateDatabaseIfModelChanges<GolfContext> // This drops and recreates db each time using seed method. Need to use CF Migrations when going live as this is fine for testing but can't lose all data in live each time schema is changed.
    {
        protected override void Seed(GolfContext context)
        {
            ...
            new Comp_Result{CompetitionID=1, GolferID=3, Position=5, GolferScore=-+2, StartDate= DateTime.Parse("2020-01-02"), EndDate=DateTime.Parse("2020-01-05")},
            ...
            new Comp_Result{CompetitionID=2, GolferID=2, Position=2, GolferScore=-14, StartDate= DateTime.Parse("2020-01-09"), EndDate=DateTime.Parse("2020-01-12")},
            ...
            new Comp_Result{CompetitionID=2, GolferID=4, Position=3, GolferScore=-10, StartDate= DateTime.Parse("2020-01-09"), EndDate=DateTime.Parse("2020-01-12")},
            new Comp_Result{CompetitionID=2, GolferID=5, Position=1, GolferScore=-23, StartDate= DateTime.Parse("2020-01-09"), EndDate=DateTime.Parse("2020-01-12")}
            };
